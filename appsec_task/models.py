...
class AppSecTask(models.Model):
    ...
    mail_loop = models.CharField(max_length=25, null=True, blank=True)
    chat_group = models.CharField(max_length=25, null=True, blank=True)
    link_ticket = models.URLField(null=True, blank=True)
    link_sharepoint = models.URLField(null=True, blank=True)
    is_internet = models.CharField(max_length=10, choices=INTERNET_CHOICES, default='Internet', null=True, blank=True)
    is_newapp = models.CharField(max_length=10, choices=IS_NEWAPP_CHOICES, default='New App', null=True, blank=True)
    checklist_type = models.CharField(max_length=50, choices=CHECKLIST_TYPE_CHOICES, default='Full Checklist', null=True, blank=True)
    sharecost = models.CharField(max_length=5, choices=SHARE_COST_CHOICES, default='No',null=True, blank=True)
